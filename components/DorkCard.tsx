  ...
  return (
    <div className="brutal-card p-8 h-full flex flex-col relative group">
      ...
      <div className={`absolute top-0 right-10 transform -translate-y-1/2 brutal-tag text-[10px] 
          ...
          aria-label={`Nível de risco: ${dork.riskLevel}`}
      >
        RISK: {dork.riskLevel}
      </div>

      <div className="flex justify-between items-center mb-8">
        <span className="brutal-tag bg-cyan-400" aria-label={`Categoria: ${dork.category}`}>
        ...
        <div className="flex gap-4">
          <button 
            ...
            title="COPIAR"
            aria-label="Copiar dork para a área de transferência"
          >
            {copied ? (
          ...
          <button 
            ...
            title="SEARCH"
            aria-label="Buscar dork no Google"
          >
      ...
      <div className="mt-4 flex items-center gap-2 opacity-30 text-[10px] font-black italic">
        <span className="w-2 h-2 bg-black" aria-hidden="true"></span>
